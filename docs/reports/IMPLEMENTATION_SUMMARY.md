...
1. **開発者向け**: `processes/REFACTORING_SAFETY.md` → `processes/DEPLOYMENT_OPERATIONS.md`
1. **運用者向け**: `processes/INCIDENT_RESPONSE.md`
1. **生徒向け**: `processes/STUDENT_DEPLOYMENT_GUIDE.md`
