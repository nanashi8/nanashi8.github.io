...
**目標単語数:** 2,500語（初級1,000語、中級800語、上級700語）  
...
生物, 自然, 食べ物, 食物, スポーツ, レジャー, 位置, 動作, 状態, 変化, 温度
時間, 色, 価格, 手続き, 文法, 形容, 量, 頻度, 前置詞, 接続詞, 限定詞, 名詞, 副詞, 評価, 感情, 性質, 程度, 方向, 場所, 建築, 道具, 家具, 物質, 植物, 状態変化, 冠詞, 動詞
```
