...
- [ ] `public/data/junior-high-entrance-words.csv`（単語）
- [ ] `public/data/junior-high-entrance-phrases.csv`（フレーズ）
- [ ] ファイルパスが正しい
...
2. **実装中**: 随時チェックし、漏れを防ぐ
3. **作業完了前**: すべての項目をチェックし、品質を保証
4. **レビュー時**: レビュアーがチェック項目を確認
