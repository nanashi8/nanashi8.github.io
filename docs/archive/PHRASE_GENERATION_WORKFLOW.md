...
2. バッチ3-4: 初級200件（人・社会、場所・移動）
3. バッチ5-6: 中級200件（言語基本、学校・学習）
4. バッチ7-8: 中級200件（人・社会、時間・数量）
5. バッチ9-10: 上級200件（各カテゴリー混合）
6. バッチ11: 残り100件（バランス調整）
...
2. **100件単位で検証**: 小さなバッチで品質を確認してから次へ進む
3. **バックアップ必須**: 統合前に必ずバックアップを作成
4. **統計確認**: 統合後、カテゴリー・難易度のバランスを確認
5. **継続的改善**: 検証で見つかった問題点をフィードバック

## 次のステップ

Phase 3完了後:
1. **Phase 4**: UI/UX拡張（熟語フィルタリング機能）
2. **Phase 5**: データ大量生成（1,100件）
3. **Phase 6**: 統合・テスト・ドキュメント整備
