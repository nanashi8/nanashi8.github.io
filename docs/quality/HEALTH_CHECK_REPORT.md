...
### 優先度: 中 🟡
1. **コンソール出力を環境変数で制御**
1. **大きすぎるファイルを分割** (特に progressStorage.ts)
1. **CSS重複を整理** (特に .milestone-progress-fill)

### 優先度: 低 🟢
1. **localStorage キーの命名規則統一** (ドキュメント化でも可)
1. **関数名の重複を解消** (実害なし)
