# Copilot Instructions - Light/Dark Mode Isolation

## ライト/ダークモード変更の絶対分離ルール
...
2. すべてのテキスト色に `dark:` バリアントがあるか
3. すべての枠線色に `dark:` バリアントがあるか
4. インラインスタイルで色を固定していないか
5. CSS変数の使用が適切か（モード分離されているか）
