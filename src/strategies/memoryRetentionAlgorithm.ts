 ...
 * エビングハウスの忘却曲線に基づく最適な復習タイミングの計算。
 *
 * **記憶獲得アルゴリズムとの統合**:
 * - 記憶獲得（同日復習）で短期記憶を形成 → 本アルゴリズムで長期記憶へ移行
 * - 記憶獲得完了後、1日後→3日後→7日後→14日後...と間隔を拡大
 * - 誤答した場合は記憶獲得アルゴリズムに戻し、再度同日復習を実施
 *
 * **科学的根拠**:
 * - SuperMemo SM-2: 正答時は間隔を拡大、誤答時はリセット
 * - エビングハウスの忘却曲線: 時間とともに記憶が減衰
 * - 間隔反復学習: 最適な間隔で復習することで記憶を強化
 */
