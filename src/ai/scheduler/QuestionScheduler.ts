...
import { ScheduleHelpers } from './helpers/ScheduleHelpers';
...
export class QuestionScheduler {
  ...
  /**
   * セッションコンテキストを構築（ScheduleHelpersに委譲）
   */
  public buildContext(params: ScheduleParams): ScheduleContext {
    return ScheduleHelpers.buildContext(params, this);
  }

  /**
   * シグナル検出（ScheduleHelpersに委譲）
   */
  public detectSignals(context: ScheduleContext): DetectedSignal[] {
    return ScheduleHelpers.detectSignals(context);
  }
