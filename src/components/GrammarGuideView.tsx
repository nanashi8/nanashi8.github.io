...
const PrepositionGuide: React.FC = () => {
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-text-color mb-4">前置詞のニュアンスと使い分け</h2>
...
const PunctuationGuide: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-text-color mb-4">英文記号の意味と使い方</h2>
