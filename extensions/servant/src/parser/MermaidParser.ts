...
export class MermaidParser {
   ...
   */
  traverse(tree: DecisionTree, context: Record<string, any>): DecisionPath {
    const path: string[] = [];
  ...
  private evaluateDecision(node: DecisionNode, context: Record<string, any>): DecisionEdge | null {
    // 各条件を評価（簡易版）
  ...
  private matchCondition(condition: string, context: Record<string, any>): boolean {
